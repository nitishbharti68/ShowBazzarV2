...
import '../Stream/stream_pages/refer_and_earn.dart';
...
class HomeDrawer extends StatelessWidget {
  ...
  void changeScreenToSettingsScreen(BuildContext context) {
    ...
    void changeScreenToReferandEarn(BuildContext context) {
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (ctx) => const ReferAndEarnPage(),
        ),
      );
  }
      ...
      child: Center(
        child: Column(
          children: [
            ...
            ListTile(
              onTap: () {
                changeScreenToReferandEarn(context);
              },
              contentPadding: const EdgeInsets.symmetric(vertical: 0, horizontal: 10),
              leading: const Icon(
                Icons.wallet_outlined,
