...
class Product{
  ...
  Product({required this.imageUrl, required this.productName, required this.productPrice});
}
List<Product> allProduct = [
  Product(imageUrl: gridAppleImageUrls[0][0], productName: gridAppleImageUrls[0][1], productPrice: gridAppleImageUrls[0][2]),
];
